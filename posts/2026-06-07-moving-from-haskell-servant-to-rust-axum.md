...
I have a couple of servers running with Haskell [servant](https://docs.servant.dev/en/latest/tutorial/index.html). If you don't know servant, it's a package for defining APIs as types. It's a nice way to define server and client APIs. If you like Haskell, definitely check it out.
