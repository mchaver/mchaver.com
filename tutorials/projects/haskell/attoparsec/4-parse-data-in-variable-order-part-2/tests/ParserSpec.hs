...
spec = do
  describe "Parser" $ do
    ...
    it "should parse \"age:25\nname:James\nphone:867-5309\"" $
      ("age:25\nname:James\nphone:867-5309" :: Text) ~> parsePerson `shouldParse` (Person "James" "867-5309" 25)

    it "should parse \"phone:867-5309\nname:James\nage:25\"" $
      ("phone:867-5309\nname:James\nage:25" :: Text) ~> parsePerson `shouldParse` (Person "James" "867-5309" 25)
